...
fn test_mint_result_success_case() {
    ...
    let mint_result = MintResult { signer, result: successful_result };
...
fn test_mint_result_error_case() {
    ...
    let mint_result = MintResult { signer, result: error_result };
...
fn test_mint_result_with_different_signers() {
    ...
    let results: Vec<MintResult> = signers.into_iter()
        .enumerate()
